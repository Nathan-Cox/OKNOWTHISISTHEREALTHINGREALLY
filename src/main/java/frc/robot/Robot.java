...
import frc.robot.auto.GoStriaght;
...
public class Robot extends TimedRobot {
  ...
  GoStriaght autonomousCommand;
  private long autoStartTime;
  private long timeSinceAutoStarted;
  ...
  public void robotInit() {
    ...
    autonomousCommand = new GoStriaght();
  ...
  public void autonomousPeriodic() {
    this.timeSinceAutoStarted = System.currentTimeMillis() - this.autoStartTime;
    
    if(this.timeSinceAutoStarted < 2000) {
      this.setDrive(0.5, 0.5);
    } else if(this.timeSinceAutoStarted < 3000) {
      this.setDrive(0, 0);
    }else{
      this.setDrive(0,0);
    }
